...
Display all orders with customer details and item price > x


*/

select fname, lname, item.sell_price
from customer, item, orderline
where  customer.customer_id = orderinfo.customer_id
and orderinfo.customer_id = orderinfo.item_id
