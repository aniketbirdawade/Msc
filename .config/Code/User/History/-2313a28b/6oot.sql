...
INSERT INTO customer(title, fname, lname, addressline, town, zipcode, phone)
VALUES('Mr','Bill','Neill','2 Beamer Street','Welltown','WT3 8GM','435 1234');
INSERT INTO customer(title, fname, lname, addressline, town, zipcode, phone)
...
/*      16
List the customers who purchsed item more than 5

select distinct fname, lname
from customer, orderinfo, orderline, item, stock
where customer.customer_id = orderinfo.customer_id
and orderinfo.orderinfo_id = orderline.orderinfo_id
and orderline.item_id = item.item_id
...
/*      17
List customer and total quantity item they purchased

select fname, lname, sum(orderline.quantity) as total_quantity
from customer, orderinfo, orderline
where customer.customer_id = orderinfo.customer_id
and orderinfo.orderinfo_id = orderline.orderinfo_id
group by fname, lname;
